...
class Session(activity: Context) {
    ...
    fun logoutUserConfirmation(activity: Activity) {
        ...
        */
        ...
        alertDialog1.setOnShowListener {
            val positiveButton = alertDialog1.getButton(AlertDialog.BUTTON_POSITIVE)
            positiveButton.setTextColor(Color.GRAY) // Change this to your desired color
            val negativeButton = alertDialog1.getButton(AlertDialog.BUTTON_NEGATIVE)
        ...
        alertDialog1.getButton(AlertDialog.BUTTON_NEGATIVE).setOnClickListener {
